        ...
        {gameState === 'START' && (
          <div className="flex-1 flex flex-col justify-center py-6">
              ...
              <div className="grid grid-cols-1 gap-2.5">
                {METHODOLOGIES.map((methodology) => (
                  <button
                    ...
                    className={`p-3 text-left rounded-xl border text-sm transition-all duration-200 focus-visible:ring-2 focus-visible:ring-teal-400 outline-none ${
              ...
              <div className="grid grid-cols-1 gap-2.5">
                {TARGETS.map((target) => (
                  <button
                    ...
                    className={`p-3 text-left rounded-xl border text-sm transition-all duration-200 focus-visible:ring-2 focus-visible:ring-indigo-400 outline-none ${
            ...
            <button
              ...
              onClick={startGame}
              className="w-full py-4 bg-gradient-to-r from-teal-500 to-indigo-500 text-black font-extrabold text-sm tracking-wider uppercase rounded-xl hover:opacity-95 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-teal-300 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950 outline-none transition-all flex items-center justify-center gap-2 shadow-lg shadow-teal-950/50"
            >
          ...
          <div className="flex-1 flex flex-col justify-between py-2 gap-4">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full p-3.5 bg-gray-900/80 hover:bg-teal-950/40 focus-visible:bg-teal-950/40 border border-gray-800 hover:border-teal-400 focus-visible:border-teal-400 focus-visible:ring-2 focus-visible:ring-teal-500 outline-none text-left rounded-xl transition-all duration-150 flex items-start gap-2.5 shadow hover:shadow-teal-950"
              >
              ...
              <button
                ...
                className="w-full p-3.5 bg-gray-900/80 hover:bg-indigo-950/40 focus-visible:bg-indigo-950/40 border border-gray-800 hover:border-indigo-400 focus-visible:border-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none text-right rounded-xl transition-all duration-150 flex items-start justify-end gap-2.5 shadow hover:shadow-indigo-950"
              >
        ...
        {gameState === 'GAMEOVER' && (
          <div className="flex-1 flex flex-col justify-center py-6 text-center">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-teal-500 to-indigo-500 text-black font-extrabold text-sm tracking-wider uppercase rounded-xl hover:opacity-95 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-teal-300 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950 outline-none transition-all flex items-center justify-center gap-2"
            >
